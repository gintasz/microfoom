...
// @public
export function args(options?: ArgsOptions): Promise<Record<string, unknown>>;

// @public (undocumented)
export function args<Output>(schema: OutputSchema<Output>, options?: ArgsOptions): Promise<Output>;
...
export interface ClaudeCliOptions {
    ...
    // (undocumented)
    readonly hooks?: DisableOnly$1;
    // Warning: (ae-forgotten-export) The symbol "InstalledPlugin" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly listPlugins?: () => readonly InstalledPlugin[] | Promise<readonly InstalledPlugin[]>;
    // Warning: (ae-forgotten-export) The symbol "DisableOnly$1" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly mcpServers?: DisableOnly$1;
    // (undocumented)
    readonly nativeTools?: readonly string[];
    readonly permissions?: "bypass" | "cli";
    // (undocumented)
    readonly plugins?: readonly string[];
    // Warning: (ae-forgotten-export) The symbol "ClaudeProcessFactory" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly processFactory?: ClaudeProcessFactory;
    // (undocumented)
    readonly skills?: DisableOnly$1;
}
...
export interface CodexCliOptions {
    ...
    readonly binary?: string;
    readonly checkpointKey?: string;
    // Warning: (ae-forgotten-export) The symbol "CodexSkill" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    ...
    // Warning: (ae-forgotten-export) The symbol "DisableOnly" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly nativeTools?: DisableOnly;
    readonly permissions?: "bypass" | "cli";
    // Warning: (ae-forgotten-export) The symbol "CodexProcessFactory" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// @public (undocumented)
export type InputPair = readonly [string, string | boolean];
...
// @public
export function parseArgs(arguments_: readonly string[]): Promise<Record<string, unknown>>;

// @public (undocumented)
export function parseArgs<Output>(arguments_: readonly string[], schema: OutputSchema<Output>): Promise<Output>;
