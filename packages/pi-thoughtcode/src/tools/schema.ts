...
export const vibeThrowParameters = thoughtcodeParametersToTypeBox(VIBE_THROW_TOOL_PARAMETERS);
...
export type VibeThrowParams = Static<typeof vibeThrowParameters>;
